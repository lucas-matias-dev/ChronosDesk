...
constexpr size_t maximumSerialLineBytes = 3072;
constexpr size_t maximumJsonBytes = 3072;
constexpr size_t maximumFields = 8;
constexpr size_t maximumDiscardedBytes = 4096;
constexpr uint32_t negotiationTimeoutMs = 15000;
}  // namespace Provisioning
...
constexpr uint8_t storageVersion = 1;
constexpr char requiredScope[] =
    "https://www.googleapis.com/auth/calendar.events.owned.readonly";
constexpr size_t maximumClientIdLength = 256;
constexpr size_t minimumRefreshTokenLength = 16;
constexpr size_t maximumRefreshTokenLength = 2048;
constexpr size_t maximumScopesLength = 128;
constexpr size_t maximumTimestampLength = 20;
}  // namespace GoogleCalendar
}  // namespace AppConfig
